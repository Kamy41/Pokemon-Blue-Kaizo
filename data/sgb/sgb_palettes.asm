...
; entries correspond to PAL_* constants
	table_width 2 * 4
	RGB 31,29,31, 21,28,11, 17,20,30, 03,02,02 ; PAL_ROUTE
	RGB 31,29,31, 25,28,27, 17,20,30, 03,02,02 ; PAL_PALLET
	RGB 31,29,31, 17,26,03, 17,20,30, 03,02,02 ; PAL_VIRIDIAN
	RGB 31,29,31, 23,25,16, 17,20,30, 03,02,02 ; PAL_PEWTER
	RGB 31,29,31, 20,26,31, 17,20,30, 03,02,02 ; PAL_CERULEAN
	RGB 31,29,31, 27,20,27, 17,20,30, 03,02,02 ; PAL_LAVENDER
	RGB 31,29,31, 30,18,00, 17,20,30, 03,02,02 ; PAL_VERMILION
	RGB 31,29,31, 16,30,22, 17,20,30, 03,02,02 ; PAL_CELADON
	RGB 31,29,31, 31,15,22, 17,20,30, 03,02,02 ; PAL_FUCHSIA
	RGB 31,29,31, 26,10,06, 17,20,30, 03,02,02 ; PAL_CINNABAR
	RGB 31,29,31, 22,14,24, 17,20,30, 03,02,02 ; PAL_INDIGO
	RGB 31,29,31, 27,27,03, 17,20,30, 03,02,02 ; PAL_SAFFRON
	RGB 31,29,31, 17,20,30, 17,23,10, 03,02,02 ; PAL_TOWNMAP
IF DEF(_RED)
...
ENDC
	...
	RGB 31,29,31, 27,22,25, 21,15,24, 03,02,02 ; PAL_PURPLEMON
	...
	RGB 31,29,31, 28,26,14, 23,18,00, 03,02,02 ; PAL_YELLOWMON
	RGB 31,29,31, 25,21,22, 15,15,18, 03,02,02 ; PAL_GRAYMON
